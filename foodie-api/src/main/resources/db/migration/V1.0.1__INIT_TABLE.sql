...
CREATE TABLE `carousel` (
  ...
  `background_color` varchar(32)   DEFAULT NULL COMMENT '背景色 背景颜色',
...
CREATE TABLE `category` (
  ...
  `logo` varchar(64)   DEFAULT NULL COMMENT '图标 logo',
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=51 DEFAULT CHARSET=UTF8MB4   COMMENT='商品分类 ';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `items_spec` VALUES ('1','cake-1005','规格名称',66,0.20,3,20000,'2020-04-25 20:42:13','2020-04-25 20:42:13'),('2','cake-1002','S',30,9.00,66,10000,'2020-04-30 00:31:31','2020-04-30 00:31:31');
...
CREATE TABLE `orders` (
  ...
  `created_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间（成交时间）',
  `updated_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '更新时间',
  PRIMARY KEY (`id`)
...
INSERT INTO `user_address` VALUES ('220451b8-bcdb-4866-8821-22d8694e973e','26cb08b7-2648-43d6-b121-061dca8bf291','amber','15784125789','上海','上海','xixixi','xixi',NULL,1,'2020-05-01 00:20:58','2020-05-01 00:20:58');
...
-- Dump completed on 2020-05-05 21:43:51
